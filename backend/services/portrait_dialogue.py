...
class PortraitDialogueService:
    ...
    def get_dialogue_line(self, portrait_id: str) -> dict[str, Any] | None:
        """
    ...
    def get_build_dialogue_line(self, build_type: str) -> dict[str, Any] | None:
        """
    ...
    async def generate_all_dialogues(
        self,
        voice_mappings: dict[str, str] | None = None,
    ...
    def get_voice_mapping(self, portrait_id: str) -> str | None:
