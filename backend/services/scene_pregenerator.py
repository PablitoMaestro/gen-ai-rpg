...
from models import PORTRAIT_CHARACTERISTICS, get_portrait_characteristics
...
class PreGenerationService:
    ...
    async def _generate_voice_narration(self, narration: str) -> Optional[str]:
    ...
    async def get_first_scene(self, portrait_id: str, build_type: str) -> Optional[Dict[str, Any]]:
