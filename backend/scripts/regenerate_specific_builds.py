#!/usr/bin/env python3
"""
Script to regenerate builds for specific portraits that have broken builds.
"""
...
async def regenerate_portrait_builds(portrait_id: str) -> None:
    ...
    logger.info(f"📸 Found {portrait_id}: {portrait_info['url']} ({gender})")
    ...
    builds = await generate_builds_for_portrait(
        ...
        portrait_url=portrait_info['url'],
...
async def regenerate_specific_builds() -> None:
    ...
    logger.info("🚀 Starting regeneration of specific character builds...")
